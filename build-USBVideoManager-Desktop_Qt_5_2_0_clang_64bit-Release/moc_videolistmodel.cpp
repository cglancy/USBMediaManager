...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_VideoListModel_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 42, 17)
    ...
    "VideoListModel\0videoChanged\0\0Video*\0"
    "video\0libraryModelReset\0"
};
...
void VideoListModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->videoChanged((*reinterpret_cast< Video*(*)>(_a[1]))); break;
        case 1: _t->libraryModelReset(); break;
        default: ;
        }
    }
}
...
const QMetaObject VideoListModel::staticMetaObject = {
    { &QAbstractListModel::staticMetaObject, qt_meta_stringdata_VideoListModel.data,
      qt_meta_data_VideoListModel,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_VideoListModel.stringdata))
